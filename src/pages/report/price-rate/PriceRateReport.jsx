...
import { Download, Printer, FileSpreadsheet, Search } from 'lucide-react';
  ...
  const { isFetching } = useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}priceRateReport`,
        {
          headers: {
                  ...
                  {reportData.length > 0 && (
                    <div className="flex justify-between items-center">
                      <div className="flex flex-row items-center gap-1 font-bold">
                        {filteredData.length > 0 ? `${filteredData.length} records found` : 'No data to display'}
                        <Button
              ...
              {reportData.length > 0 ? (
                <div>
                  ...
                  <div ref={containerRef} className="md:overflow-x-auto">
                    <div className="p-4">
                      <h1 className="text-2xl font-bold text-center">Price Rate Report</h1>
                    </div>
                    ...
                    <div className="border-t border-l border-r border-black text-[13px]">
                      <div
                        ...
                        style={{
                          gridTemplateColumns: "1fr 1fr 1fr 0.8fr 0.8fr 0.8fr 0.8fr",
                        }}
                      >
                        <div className="p-2 font-bold border-b border-r border-t border-black text-gray-900 text-center" style={{ gridColumn: 'span 1' }}>
                          Mill
                        </div>
                        <div className="p-2 font-bold border-b border-r border-t border-black text-gray-900 text-center" style={{ gridColumn: 'span 1' }}>
                          Party
                        ...
                        <div className="p-2 font-bold border-b border-r border-t border-black text-gray-900 text-center" style={{ gridColumn: 'span 2' }}>
                          Purchase
                        </div>
                        <div className="p-2 font-bold border-b border-r border-t border-black text-gray-900 text-center" style={{ gridColumn: 'span 2' }}>
                          Sale
