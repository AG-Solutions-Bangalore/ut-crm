...
import { BALANCE_RECEIVABLE_REPORT } from "../../../api";
...
const BalanceReceivableReport = () => {
  ...
  const handleExcelExport = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `Balance-Receivable-Report-${dayjs().format(
        "DD-MM-YYYY"
      )}.xlsx`;
      link.click();
                                  ...
                                  ([month, monthData]) => {
                                    ...
                                    return (
                                      <div key={month} className="mb-4">
                                        <h3 className="p-2 bg-gray-100 font-semibold border-b border-black">
                                          {month}
                                        </h3>
                                        ...
                                        <div
                                          ...
                                          style={{
                                            gridTemplateColumns:
                                              "0.5fr 0.8fr 1.2fr 0.8fr 0.8fr 0.8fr 0.8fr 0.8fr",
                                          }}
                                        >
                                          {[
                                            "SL No",
