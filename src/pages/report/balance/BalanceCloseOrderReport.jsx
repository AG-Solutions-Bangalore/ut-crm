...
import { BALANCE_CLOSED_REPORT } from "../../../api";
import Loader from "../../../components/common/Loader";
import { useGetApiMutation } from "../../../hooks/useGetApiMutation";

const BalanceCloseOrderReport = () => {
  const containerRef = useRef(null);
  const {
    data: result,
    isLoading,
  } = useGetApiMutation({
    url: BALANCE_CLOSED_REPORT,
    queryKey: ["balanceCloseReport"],
  });
  ...
  const handleDownload = () => {
    ...
    const options = {
      margin: [10, 10, 10, 10],
      filename: `Balance-Close-Order-Report-${dayjs().format(
        "DD-MM-YYYY"
      )}.pdf`,
  ...
  const handleExcelExport = async () => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("Balance Close Order Report");
      ...
      Object.entries(groupedReportData).forEach(([millName, millData]) => {
        ...
        millData.forEach((item, index) => {
          worksheet.addRow({
            ...
            total_billing_tones: parseFloat(item.total_billing_tones).toFixed(
              2
            ),
      ...
      link.href = url;
      link.download = `Balance-Close-Order-Report-${dayjs().format(
        "DD-MM-YYYY"
      )}.xlsx`;
      link.click();
  ...
  const overallTotals = calculateOverallTotals();
  if (isLoading) {
    return <Loader msg="Balance Close Order Report" />;
  }
  return (
      ...
      <div className="max-w-full mx-auto">
        <div className="flex flex-col lg:flex-row gap-2">
          <div className="w-full">
            <Card
              title="Balance Close Order Report"
            ...
            >
              {reportData.length > 0 ? (
                  ...
                  <div ref={containerRef} className="md:overflow-x-auto">
                    ...
                    <div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{
                                  gridTemplateColumns:
                                    "0.5fr 1.2fr 0.8fr 0.8fr",
                                }}
                              >
                                {["SL NO", "PO Ref", "Tones", "Balance"].map(
                                  (header, idx) => (
                                    <div
                                      key={idx}
                      ...
                      <div
                        ...
                        style={{
                          gridTemplateColumns: "0.5fr 1.2fr 0.8fr 0.8fr",
                        }}
                      >
                ...
                <div className="text-center py-20 text-gray-400">
                  ...
                  <p>No balance close order data available.</p>
                </div>
              )}
            </Card>
          </div>
...
export default BalanceCloseOrderReport;
