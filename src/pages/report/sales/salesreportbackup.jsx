...
const SalesReport = () => {
  ...
  const totals = calculateTotals();
  const selectedMonthText = monthsData?.data?.find(
    (month) => month.formatted_date === selectedMonth
  )?.formatted_date;
                  ...
                  >
                    ...
                    >
                      {monthsData?.data?.map((month) => (
                        <Option
                          key={month.formatted_date}
                          value={month.formatted_date}
                        >
                  ...
                  <div ref={containerRef} className="md:overflow-x-auto">
                    <div className="p-4">
                      <h1 className="text-2xl font-bold text-center">
                        SALES COMMISSION REPORT FOR THE MONTH OF -{" "}
                        {selectedMonthText}
                      </h1>
                    </div>
