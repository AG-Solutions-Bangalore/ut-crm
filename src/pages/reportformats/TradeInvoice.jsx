      ...
      <div className="flex justify-center bg-gray-50 p-4">
        <div className="w-full max-w-[210mm] bg-white border border-black" ref={componentRef}>
          ...
          <div className="grid grid-cols-2 border-b border-black">
            ...
            <div className="border-r border-black p-3">
              <div className="text-xs space-y-1">
                <div>
                  <span className="font-bold">To : TRISHA PACKAGING INDUSTRIES</span>
                </div>
          ...
          <table className="w-full border-collapse text-xs">
            ...
            <tbody>
              <tr>
                <td className="border-r border-black p-2 text-center align-top">1</td>
                <td className="border-r border-black p-2 align-top">
                  <div>CRAFT PAPER</div>
                  <div>BF - 18, GSM - 180, SIZE - 92,</div>
                  <div>Shade - NATURAL</div>
                </td>
                <td className="border-r border-black p-2 text-center align-top">6</td>
                <td className="border-r border-black p-2 text-right align-top">2,719.000</td>
                <td className="border-r border-black p-2 text-right align-top">31.00</td>
            ...
            <div className="flex">
              ...
              <div className="flex-1 border-r border-black p-3">
                ...
                <div className="text-xs">
                  ...
                  <span className="font-bold">Ninety Four Thousand Four Hundred Three</span>
                </div>
