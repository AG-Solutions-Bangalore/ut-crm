...
import { TRADE_INVOICE_EMAIL, TRADE_INVOICE_LIST } from "../../api";
  ...
  const handleEmail = async () => {
    ...
    try {
      const res = await emailTrigger({
        url: `${TRADE_INVOICE_EMAIL}/${id}?type=${payload}`,
      });
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1 text-center">
                  ...
                  <p className="text-[10px] leading-tight">
                    ...
                    <br />
                    Correspondence Address : {company?.company_cor_address}{" "}
                ...
                <div className="text-xs space-y-1">
                  <div>
                    <span className="font-bold">
                      To : {selectedParty?.party_name}{" "}
                    </span>
                  </div>
                  <div>{selectedParty?.party_billing_address}</div>
                  ...
                  return (
                    <tr key={item.id}>
                      ...
                      <td className="border-r border-black p-2 align-top">
                        <div>KRAFT PAPER</div>
                        <div>
                          BF - {item.trade_invoice_sub_bf}, GSM -{" "}
                          {item.trade_invoice_sub_gsm}, SIZE -{" "}
                          {item.trade_invoice_sub_size},
                        </div>
                        <div>Shade - {item.trade_invoice_sub_shade}</div>
                      </td>
                      <td className="border-r border-black p-2 text-center align-top">
                        {parseFloat(item.trade_invoice_sub_reel).toFixed(2)}
                      </td>
            ...
            <div className="border-t border-black flex">
              <div className="flex-1 p-3 text-[10px]">
                ...
                <div className="space-y-0.5">
                  <div>
                    1. Any dispute is subject to Bangalore jurisdiction.
                  </div>
                  <div>
                    2. Payment to be made by A/c Payee cheque or DD only.
                  </div>
