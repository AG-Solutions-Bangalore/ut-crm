                          ...
                          {/* <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-10 gap-3 mt-6">
                            ...
                            >
                              ...
                              <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm mt-6">
                                {/* Header */}
                                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-10 gap-3 bg-gray-100 p-2 font-semibold text-gray-700 text-sm border-b">
                                  <div>Shade</div>
                                  <div>Item</div>
                                  <div>GSM</div>
                                  <div>Size</div>
                                ...
                                <div className="max-h-60 overflow-y-auto">
                                  {fields.map(({ key, name, ...restField }) => (
                                    <div
                                      key={key}
                                      className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-10 gap-3 p-2  hover:bg-gray-50 transition"
                                    >
                                      <Form.Item
                                        {...restField}
                                        name={[name, "shade"]}
